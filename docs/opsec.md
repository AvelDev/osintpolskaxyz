...
Zbiór wskazówek i narzędzi związanych z ochroną operacyjną w kontekście OSINT. Obejmuje praktyki bezpieczeństwa, które mogą być przydatne w codziennym wykonywaniu zadań OSINT, zarówno w kontekście prywatnym, jak i profesjonalnym.

## Programy

- ⭐ [VirtualBox](https://www.virtualbox.org/) - Oprogramowanie do wirtualizacji systemów operacyjnych.

## Systemy operacyjne

- ⭐ [Kali Linux](https://www.kali.org/) - Popularna dystrybucja Linuksa oferująca bogaty zestaw narzędzi do testowania penetracyjnego, analizy sieci i pozyskiwania informacji.
